# -*- coding: utf-8 -*-
"""YELP_all_models.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-OnYyzXsLxt9wjMsZhx2IetREfPap8RF
...
Next SST training and test datasets are downloaded, the training data is split into training and validation datasets. It takes TEXT and LABEL as inputs so that the data is processed as specified.
"""
...
TEXT = data.Field(lower=True, batch_first=False, tokenize='spacy')#, fix_length=400)
LABEL = data.LabelField(dtype=torch.long)

train_data, test_data = YELP.splits(TEXT, LABEL, root='tmp/yelp2015')
train_data, valid_data = train_data.split(split_ratio=0.8, random_state=random.seed(SEED))

ls -laht tmp/yelp2015/yelp/*

cat tmp/yelp2015/yelp/yelp_review_full_csv/test.csv | tail -20
...
class TextTCN(nn.Module):
    ...
    def forward(self, x):
        sequence_length, batch_size = x.shape
        #print(x.shape)
        x = self.embedding(x.transpose(1,0))
        #print(x.shape)
...
class MyGRU(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, num_layers=2, bias=True, dropout=None):
